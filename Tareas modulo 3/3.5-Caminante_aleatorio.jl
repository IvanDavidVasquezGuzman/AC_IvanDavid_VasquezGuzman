...
# ╔═╡ 42b05cdb-fe22-4833-90f8-83653c3abf43
using Plots
...
# ╔═╡ 575d698f-57a7-4415-ace0-57d52297d85d
# Probamos las funciones
rand()

# ╔═╡ 33e7c6c0-4082-4268-9487-17a28ba53fb7
rand(Int)

# ╔═╡ 9897316b-1d9b-4114-ae44-c7d70e0bf70f
rand(Bool)
...
# ╔═╡ cb95c329-e631-48b5-885f-16d88e990673
# Probamos las nuevas funciones.
rand(n)

# ╔═╡ 37c166fc-9573-4db5-b4a3-3fa4d809f025
rand(Int,n)

# ╔═╡ 97e6dd95-4121-484a-9651-a29598109f96
rand(Bool,n)
...
function aleatorioUniforme(a,b)
	# Definimos una variable que almacene el número aleatorio entre a y b.
	numero_aleatorio = rand(a:b)
	# Pedimos que nos regrese el número aleatorio.
	return numero_aleatorio
end

# ╔═╡ 2d35ad4e-85c0-4a23-8e14-2bdc061f01be
# Probamos nuestra función.
aleatorioUniforme(2,9)
...
# ╔═╡ ef8c77f5-8855-4348-a2c2-52754458b822
begin
# Definimos una variable que almacene los numéros aleatorios.
x = zeros(1000)
# Hacemos un ciclo que almacene los numeros aleatorios.
for i in range(1,1000,step=1)
	# Usamos nuestra función aleatorioUniforme para calcular los números aleatorios.
	x[i] = aleatorioUniforme(2,6)
end
	# Hacemos un histograma de los números aleatorios.
	histogram(x)
end
...
# Definimos nuestra función sin parámetros
function unPaso()
	# Usamos la función rand que solo tomara valores 1 y -1.
	paso = rand((-1,1))
	# Pedimos que nos regrese el valor.
	return paso
end

# ╔═╡ e9fb7180-00c2-4b82-bd9d-f5eab39a2732
# Probamos nuestra función.
unPaso()

# ╔═╡ 86ece68f-bee4-49e0-8b38-e0105b62498a
# Hacemos un histograma para que tengan la misma probabilidad de ocurrir -1 y 1.
begin
# Definimos una variable que almacene los numéros aleatorios.
p = zeros(1000)
# Hacemos un ciclo que almacene los numeros aleatorios.
for i in range(1,1000,step=1)
	# Usamos nuestra función unPaso para calcular los números aleatorios.
	p[i] = unPaso()
end
	# Hacemos un histograma de los números aleatorios.
	histogram(p)
end
# Note que la función un paso solo toma valores -1 y 1 pero para realizar el histograma parece que toma valores -1 a -0,5 y 1 a 1.5.
