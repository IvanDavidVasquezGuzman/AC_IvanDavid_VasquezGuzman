...
# ╔═╡ 6209acd7-cd69-4ece-b8d2-677f48c7a8bb
@bind d Slider(0.01:0.01:1, default=0.5)
#Asignamos un valor a 'l1' a través de un deslizador interactivo que toma valores en 0.05:0.05:2.
...
# ╔═╡ 64a86648-d190-4d41-b044-929e70281917
f(2π)
...
begin
	...
	for t in tiempo # Iniciamos el ciclo for que realizara las gráficas
		...
		plot!(x.(tiempo),hp.(tiempo), legend = false , style = :dash) # Gráficamos su trayetoria.
